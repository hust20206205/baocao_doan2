...
% \input{contents/p1_hddt_chi_tiet_cac_chuc_nang_cua_bai_toan_chinh}
...
% \input{contents/p3_ddd_tim_hieu_ve_thiet_ke_huong_mien}
...
% \input{contents/p3_ddd_tich_hop_lien_tuc_continuous_integration}
% \subsection{Bối cảnh bị giới hạn (Bounded Context)}
% \input{contents/p3_ddd_boi_canh_bi_gioi_han_bounded_context}
% \subsection{Mối quan hệ bối cảnh bị giới hạn (Bounded Context Relationships)}
% \input{contents/p3_ddd_moi_quan_he_boi_canh_bi_gioi_han_bounded_context_relationships}
% \subsection{Bản đồ bối cảnh (Context Maps)}
% \input{contents/p3_ddd_ban_do_boi_canh_context_maps}

% \newpage
% \section{Các mẫu kỹ thuật trong thiết kế hướng miền}
% \input{contents/p3_ddd_cac_mau_ky_thuat_trong_thiet_ke_huong_mien}
% \subsection{Đối tượng thực thể (Entities Objects)}
% \input{contents/p3_ddd_doi_tuong_thuc_the_entities_objects}
% \subsection{Đối tượng giá trị (Value Objects)}
% \input{contents/p3_ddd_doi_tuong_gia_tri_value_objects}
% \subsection{Tổng hợp (Aggregates)}
% \input{contents/p3_ddd_tong_hop_aggregates}
% \subsection{Nhà máy (Factory)}
% \input{contents/p3_ddd_nha_may_factory}
% \subsection{Kho lưu trữ (Repository)}
% \input{contents/p3_ddd_kho_luu_tru_repository}
% \subsection{Miền dịch vụ (Domain Service)}
% \input{contents/p3_ddd_mien_dich_vu_domain_service}
% \subsection{Kiến trúc phân lớp (Layered Architecture)}
% \input{contents/p3_ddd_kien_truc_phan_lop_layered_architecture}
...
% \input{contents/p3_ddd_kien_truc_luc_giac_hexagon_architecture}
% % Adapter hẽagon củ hành
...
% \section{Thùng chứa  và quản lí thùng chứa (Container and Container Orchestration)}
